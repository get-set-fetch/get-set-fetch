...
const BaseSite = gsfRequire('lib/storage/base/BaseSite');
...
class MongoSite extends BaseSite {
  static get builder() {
    return MongoResource.db.collection('Sites');
  }
  ...
  getResourceToCrawl(crawlFrequency) {
    ...
    return MongoResource.getResourceToCrawl(this.id, crawlFrequency);
  }

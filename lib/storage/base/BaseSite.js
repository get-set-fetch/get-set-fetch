    ...
    while (this.crawlOpts.connectionsActive < this.crawlOpts.maxConnections) {
      ...
      this.crawlResource()
        .then((resource) => {
          this.crawlOpts.connectionsActive -= 1;
          if (resource) {
            // if a resource was found and there's no pending crawl, attempt to crawl another one
          ...
          } else if (this.crawlOpts.connectionsActive === 0 && !this.crawlOpts.crawlTimeout) {

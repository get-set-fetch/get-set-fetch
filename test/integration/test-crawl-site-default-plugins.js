    ...
    */
    describe('Test Scenario: parse html resources\n' +
      ...
      it('crawl resource - index.html, 1st page, depth 0', async () => {
        ...
        assert.strictEqual(
          TestUtils.sanitize(String(fs.readFileSync('test/integration/crawl-site-default-plugin/index.html'))),
          TestUtils.sanitize(resource.content),
        );
      ...
      it('crawl resource - pageA.html, 2nd page, depth 1', async () => {
        ...
        // verify resource content
        assert.strictEqual(
          TestUtils.sanitize(String(fs.readFileSync('test/integration/crawl-site-default-plugin/pageA.html'))),
          TestUtils.sanitize(resource.content),
        );
      ...
      it('crawl resource - pageB.html, 3rd page, depth 2', async () => {
        ...
        // verify resource content
        assert.strictEqual(
          TestUtils.sanitize(String(fs.readFileSync('test/integration/crawl-site-default-plugin/pageB.html'))),
          TestUtils.sanitize(resource.content),
        );
